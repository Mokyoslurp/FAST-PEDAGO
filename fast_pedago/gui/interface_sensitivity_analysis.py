...
#######################################################
        ...
        self.analysis_back_home_button.on_event('click', lambda widget, event, data : self.display_main_menu(event))
        ...
        self.clear_all_button.on_event('click', lambda widget, event, data : self.clear_all_files(event))
